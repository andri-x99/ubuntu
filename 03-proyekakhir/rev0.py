from s_requestapi_v1 import *
from s_connection import Conn
...
class updateData():
    def insertUpdateData():      
        ...
        for campuran_null_array_string in Conn().db.coba4.find():
            ...
            # VERSI GABUNG
            Conn().db.coba4.update_many( {"mysql_details.mysql_command":{'$eq':null}}, {'$unset':{"mysql_details":0}} )
            Conn().db.coba4.update_many({},{'$pull': {"mysql_details":{"mysql_command": {'$eq':null}} } },upsert=True)
